valley_description_dictionary = [
  [`The Valley of the Quest`,
    `When you begin the Valley of the Quest <br>
    Misfortunes will deprive you of all rest. <br>
    Renounce the world, your power, <br>
    and all you own,  <br>
    And in your heart’s blood journey on alone. <br>
    When love inspires his heart, <br>
    he begs for wine, <br>
    One drop to be vouchsafed him as a sign. <br>`,
  ...
  [`The Valley of Love`,
      `Love's valley is the next, <br>
      and here desire <br>
      Will plunge the pilgrim into seas of fire. <br>
      To whom both good and evil are the same, <br>
      And who is neither, but a living flame. <br>
      Love here is fire; <br>
      its thick smoke clouds the head – <br>
      When love has come the intellect has fled. <br>`,
  ...
  [`The Valley of Insight into Mystery`,
      `The next broad valley <br>
      which the traveller sees <br>
      Brings insight into hidden mysteries.<br>
      Our insight comes to us by different signs; <br>
      One prays in mosques and one in idols’ shrines.<br>
      His essence will shine forth; <br>
      the world that seemed <br>
      A furnace will be sweeter than he dreamed. <br>`,
  ...
  [`The Valley of Detachment`,
      `Next comes the Valley of Detachment; <br>
       here All claims, all lust for meaning disappear. <br>
      The seven planets seem a fading spark, <br>
      The seven seas a pool... <br>
      The seven planets seem a fading spark, <br>
      The seven seas a pool,  <br>
      and heaven’s arc <br>
      Is more like dust and death than paradise. <br>`,
  ...
  [`The Valley of Unity`,
      `Next comes the Valley of pure Unity, <br>
      place of lonely, long austerity, <br>
      And all who enter on this waste have found <br>
      Their various necks by one tight collar bound. <br>
      All talk of two implies plurality – <br>
      When two has gone there will be Unity. <br>
      Lose yourself in Him; this is tohid, unity <br>
      Lose your loss, this is tafrid, unification <br>`,
  ...
  [`The Valley of Bewilderment`,
      `Next comes the Valley of Bewilderment, <br>
      A place of pain and gnawing discontent – <br>
      ...here I cannot find <br>
      That rope by which men live,  <br>
      the rational mind  <br>
      Once in the Valley of Bewilderment <br>
      The pilgrim suffers endless discontent. <br>`,
  ...
  [`The Valley of Poverty and Nothingness`,
      `Next comes that valley words cannot express, <br>
      The Vale of Poverty and Nothingness. <br>
      And in self-loss obtains eternal rest; <br>
      The heart that would be lost in this wide sea <br>
      And in self-loss obtains eternal rest; <br>
      The heart that would be lost in this wide sea <br>
      Disperses in profound tranquility. <br>`,
...
function loadDescription(user_position){
  ...
  title_div.setAttribute("style", "text-align:center; font-style:italic; font-size:26px;");
  ...
  poetry_div.setAttribute("style", "padding-left: 0.5em; font-style:italic;");
